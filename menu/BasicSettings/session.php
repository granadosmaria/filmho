        ...
        <ul class="sidebar-links">
            ...
            <li class="submenu">
                ...
                <ul class="submenu-links">
                    ...
                    <li><a href="#"><i class="fas fa-clock"></i> Session</a></li>
...
<li class="submenu">
    ...
    <div class="main-content">
        <div id="content">
            ...
            <!-- Formulario para agregar nuevas sesiones -->
            <form action="session.php" method="POST">
                <label for="name">Name:</label>
                <input type="text" id="name" name="name" required>
                <button type="submit" class="btn-black">Add Session</button>
            </form>
            
            <!-- Barra de búsqueda -->
            <form method="POST" action="session.php" class="search-form">
                <input type="text" name="search" placeholder="Buscar sesión..." value="<?php echo $search_query; ?>" class="search-input">
            ...
            <table border="1">
                ...
                <tbody>
                    <?php
                    // Mostrar las sesiones desde la base de datos
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td>" . $row['id'] . "</td>";
                            echo "<td>" . $row['name'] . "</td>";
                            // Columna para las acciones de editar y eliminar
                            echo "<td>
                                    <a href='editSession.php?id=" . $row['id'] . "'><i class='fas fa-edit'></i></a> |
                                    <a href='deleteSession.php?id=" . $row['id'] . "'><i class='fas fa-trash'></i></a>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='3'>No hay sesiones disponibles</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
            ...
            <div class="pagination">
                <?php
                if ($page > 1) {
                    echo "<a href='session.php?page=" . ($page - 1) . "'>&laquo; Anterior</a>";
                }
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    if ($i == $page) {
                        ...
                        echo "<a href='session.php?page=$i'>$i</a>";
                    }
                }

                if ($page < $total_pages) {
                    echo "<a href='session.php?page=" . ($page + 1) . "'>Siguiente &raquo;</a>";
                }
                ?>
            </div>
        </div>
